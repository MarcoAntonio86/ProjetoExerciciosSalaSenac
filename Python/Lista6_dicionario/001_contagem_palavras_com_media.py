...
'''if media_aluno >= 85:
        estatus['aprovado'].append(nome)
else:
        estatus['reprovado'].append(nome)'''

'''print(f'Alunos aprovados: {estatus["aprovado"]}')
print(f'Alunos reprovados: {estatus["reprovado"]}')'''

'''print("Alunos Aprovados:")
for nome in estatus['aprovado']:
    print(nome)

print("Alunos Reprovados:")
for nome in estatus['reprovado']:
    print(nome)'''

'''print(estatus)'''

'''if media_aluno >= 85:
    remover = nome.pop(cadastro['nomes'])
    estatus['aprovado'].append(remover)'''
